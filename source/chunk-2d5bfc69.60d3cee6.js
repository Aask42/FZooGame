    ...
    ["chunk-2d5bfc69"], {
        ...
        b44f: function (t, e, a) {
            ...
            var i = function () {
                    ...
                    return i("div", [i("b-button", {
                    ...
                    }, [t._v(t._s(t.$t("CombatPage.Rank")))]), i("b-overlay", {
                        attrs: {
                            show: t.loading,
                            rounded: "sm"
                        }
                    ...
                    }, [i("newbie-rewards-description"), i("b-card", [i("ol", [i("li", {
                        staticClass: "mt-75"
                        ...
                        staticClass: "mt-75"
                    }, [t._v(" Daily Key Reward Claiming: Next day UTC 10:00.")])])])], 1)], 1)], 1)
                },
                s = [],
                n = a("99a5"),
                r = a("1c03"),
                o = (a("6a61"), a("6540"), a("7478"), a("402f"), a("d2ba")),
                l = a("19f5"),
                c = a("a13e"),
                u = a("cf6b"),
                d = a("bf32"),
                ...
                b = {
                    ...
                    mounted: function () {
                        this.getRecords(this.pager.currentPage, this.pager.perPage), this.keyReward()
                    },
                    computed: Object(r["a"])({}, Object(u["b"])("farm", ["defaultAccount"])),
                    methods: {
                        ...
                        getRecords: function (t, e) {
                            ...
                            c["a"].get("/api/pvpNewbie/realRanking", i).then((function (e) {
                            ...
                            return Object(n["a"])(regeneratorRuntime.mark((function e() {
                                return regeneratorRuntime.wrap((function (e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                                            Object(d["c"])().keyReward(t.defaultAccount).then((function (e) {
                                                t.pendingParticipationKeys = m["a"].toFixed(v["a"].utils.formatUnits(e, f["a"].key.decimals))
                                            })), Object(d["a"])().keyReward(t.defaultAccount).then((function (e) {
                                                t.pendingDailyKeys = m["a"].toFixed(v["a"].utils.formatUnits(e, f["a"].key.decimals))
                                            }));
                                        case 2:
                                        case "end":
                                            return e.stop()
                        ...
                        claimParticipationRewards: function () {
                            ...
                            return Object(n["a"])(regeneratorRuntime.mark((function e() {
                                return regeneratorRuntime.wrap((function (e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                                            t.loadingKey.participation = !0, Object(d["c"])().getReward().then(function () {
                        ...
                        claimDailyRewards: function () {
                            ...
                            return Object(n["a"])(regeneratorRuntime.mark((function e() {
                                return regeneratorRuntime.wrap((function (e) {
                                    while (1) switch (e.prev = e.next) {
                                        case 0:
                                            t.loadingKey.daily = !0, Object(d["a"])().getReward().then(function () {
                                                var e = Object(n["a"])(regeneratorRuntime.mark((function e(a) {
                                                    return regeneratorRuntime.wrap((function (e) {
                                                        while (1) switch (e.prev = e.next) {
                                                            case 0:
                ...
                g = b,
                p = a("4ac2"),
                w = Object(p["a"])(g, i, s, !1, null, "6058fedc", null);
            e["default"] = w.exports
        },
        d2ba: function (t, e, a) {
            "use strict";
            var i = function () {
                ...
                l = o,
                c = (a("a145"), a("4ac2")),
                u = Object(c["a"])(l, i, s, !1, null, "01a91ad2", null);
            e["a"] = u.exports
        },
        d6f6: function (t, e, a) {
            "use strict";
            var i = function () {
                ...
                r = n,
                o = a("4ac2"),
                l = Object(o["a"])(r, i, s, !1, null, "539b2478", null);
            e["a"] = l.exports
        },
        ee15: function (t, e) {
